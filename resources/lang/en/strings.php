    ...
    */
    ...
    'backend' => [
        ...
        'options' => [
            'print'   => 'Print Options',
            'cost'    => 'Cost Options',
            'self-legal-entities' => 'Self Legal Entities',
        ],
    ...
    'customer' => [
        'order' => [
            ...
            'parameters'  => 'Parameters and Order Calculation',
    ...
    'dtp' => [
        'file_for_print'                => 'File for printing',
        'file_for_cut'                  => 'File for cutting',
        'file_for_print_for_plotter'    => 'File for printing for a plotter',
        'file_for_cut_for_plotter'      => 'File for cutting on a plotter',
    ],
];
