    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'created_confirm'   => 'Ваша учетная запись успешно создана. Мы отправили вам уведомление на ваш E-mail для подтверждения вашей учетной записи.',
                'created_pending'   => 'Ваша учетная запись сохранена и находится на рассмотрении. После удтверждения вашей учетной записи, вам будет отправлено уведомление на ваш E-mail.',
