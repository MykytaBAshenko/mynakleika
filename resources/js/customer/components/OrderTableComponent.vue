    ...
    <b-row class="justify-content-between pt-2">
      <b-col cols="12" md="4">
        <b-form-group class="pb-2">
          <b-input-group>
            <b-form-input debounce="1000" v-model="filterVal"
                          :placeholder="__('strings.backend.general.search_placeholder')"/>
            <b-input-group-append>
              <b-btn :disabled="!filterVal" @click="filterVal = ''">{{
                  __('strings.backend.general.search_clear')
                }}
              </b-btn>
            </b-input-group-append>
          </b-input-group>
